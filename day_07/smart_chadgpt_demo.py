...
class SmartChadGPTDemo:
    ...
    async def _check_api_key(self):
        ...
        if not self.has_chadgpt:
            ...
            print("   Set CHADGPT_API_KEY environment variable to test with real API calls.")
    ...
    async def _demo_smart_generation(self):
        ...
        tasks = [
            ...
            },
            {
                ...
                "language": "python", 
                "requirements": ["Include insert, delete, search", "Add traversal methods", "Use proper OOP"]
            }
        ]
        ...
        try:
            ...
            if gen_success and rev_success:
                ...
                result = await orchestrator.orchestrate_code_generation_and_review(
                    ...
                    language="python",
                    requirements=["Use FastAPI", "Include authentication", "Add comprehensive tests"]
                )
                ...
                if 'generation_result' in result:
                    ...
                    print(f"📝 Generated code: {len(gen_result.generated_code)} characters")
                
                if 'review_result' in result:
                    rev_result = result['review_result']
                    print(f"🔍 Review completed: {len(rev_result.review_result)} characters")
    ...
    async def _demo_performance_comparison(self):
        ...
        for model in models_to_test:
            try:
                ...
                if await generator.check_provider_availability():
                    ...
                    print(f"✅ {model}: {result.tokens_used} tokens, {processing_time:.2f}s")
        ...
        if successful_results:
            ...
            for result in successful_results:
                print(f"{result['model']:<15} {result['tokens']:<8} {result['time']:<8.2f} {result['code_length']:<8}")
            ...
            print(f"💡 Most efficient: {most_efficient['model']} ({most_efficient['tokens']} tokens)")
        else:
