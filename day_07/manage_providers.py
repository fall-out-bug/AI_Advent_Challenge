...
@click.option('--model', default=None, help='Model name (for chadgpt: gpt-5, gpt-5-mini, gpt-5-nano, claude-4.1-opus, claude-4.5-sonnet)')
...
def recommend(task_description: str, language: str, prefer_speed: bool, prefer_quality: bool, show_all: bool):
    ...
    if show_all:
        ...
        all_recommendations = selector.get_all_recommendations(task_description, language)
