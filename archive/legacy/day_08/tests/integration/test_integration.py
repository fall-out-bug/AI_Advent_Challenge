...
from models.data_models import CompressionResult, ExperimentResult, TokenInfo
...
class TestMLClientIntegration:
    ...
    def setup_method(self):
        ...
        self.hybrid_counter = HybridTokenCounter(
            ml_client=self.mock_ml_client, fallback_counter=self.token_counter
        )
...
class TestExperimentIntegration:
    ...
    def setup_method(self):
        ...
        self.experiments = TokenLimitExperiments(
            self.mock_model_client, self.token_counter, self.text_compressor
        )
    ...
    def test_experiment_result_builder_integration(self):
        ...
        result = (
            builder.with_experiment_name("integration_test")
...
class TestEndToEndIntegration:
    ...
    def test_factory_pattern_integration(self):
        ...
        simple_counter = TokenCounterFactory.create_simple(
            limit_profile=LimitProfile.PRACTICAL, config=self.mock_config
        )
