...
class StatisticsCalculator:
    ...
    def calculate_compression_stats(
        ...
        tokens_saved = [
            result.original_tokens - result.compressed_tokens for result in results
        ]
    ...
    def calculate_experiment_stats(
        ...
        compression_ratios = [
            r.compression_result.compression_ratio
            for r in results
    ...
    def calculate_strategy_comparison_stats(
        self, results: List[ExperimentResult]
    ) -> Dict[str, Dict[str, Any]]:
        ...
        for strategy_name, strategy_results in strategies.items():
            strategy_stats[strategy_name] = self.calculate_experiment_stats(
                strategy_results
            )
    ...
    def calculate_performance_metrics(
        ...
        response_times_ms = [
            r.response_time * 1000 for r in results if r.response_time is not None
        ]
    ...
    def calculate_efficiency_metrics(
        ...
        for result in results:
            ...
            if result.compression_result:
                compression_efficiencies.append(
                    result.compression_result.compression_ratio
                )
        ...
        return {
            ...
            "avg_compression_efficiency": self.calculate_average(
                compression_efficiencies
            ),
...
"""
    ...
    def generate_model_comparison_report(self, results: List[ExperimentResult]) -> str:
        ...
        for model_name, stats in model_stats.items():
            ...
            report += (
                f"  Avg Compression Ratio: {stats['avg_compression_ratio']:.2f}\n\n"
            )
