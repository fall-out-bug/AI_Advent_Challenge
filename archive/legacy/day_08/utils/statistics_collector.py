...
class StatisticsCollector:
    ...
    def collect_performance_stats(
        ...
        time_difference = (
            slowest_experiment.response_time - fastest_experiment.response_time
        )
    ...
    def _analyze_strategies(
        self, compressed_results: List[ExperimentResult]
    ...
    def _analyze_model_performance(
        ...
        for model_name, model_results in models.items():
            ...
            model_performance[model_name] = {
                ...
                "generation_speed": avg_output_tokens / avg_response_time
                if avg_response_time > 0
                else 0,
                "experiment_count": len(model_results),
                "success_rate": len([r for r in model_results if r.response])
                / len(model_results)
                * 100,
            }
