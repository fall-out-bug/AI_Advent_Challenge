...
class ExperimentResultBuilder:
    ...
    def with_tokens(
        self, input_t: int, output_t: int, total: int
    ...
    def with_compression(
        self, applied: bool, result: Optional[CompressionResult] = None
    ) -> "ExperimentResultBuilder":
        """
    ...
    def build(self) -> ExperimentResult:
        ...
        missing_fields = [
            field for field in required_fields if field not in self._result
        ]
        if missing_fields:
