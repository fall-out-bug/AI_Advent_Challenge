...
def main():
    """Main entry point."""
    if len(sys.argv) < 2:
        print("Usage: python scripts/quality/diag_search.py <query> [limit]")
        print()
        print("Examples:")
        print("  python scripts/quality/diag_search.py 'крупнокалиберный_переполох'")
        print("  python scripts/quality/diag_search.py 'деградат нация' 10")
        sys.exit(1)
