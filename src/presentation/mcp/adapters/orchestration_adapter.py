...
class OrchestrationAdapter:
    ...
    async def orchestrate_generation_and_review(
        ...
        Raises:
            ...
            MCPOrchestrationError: If orchestration fails
        """
        try:
    ...
    def _validate_inputs(
        ...
        Raises:
            MCPValidationError: If any input is invalid
        """
    ...
    def _create_agents(
        self, gen_model: str, review_model: str
    ) -> dict[str, Any]:
        ...
        Returns:
            Dictionary with generator and reviewer agents
        """
