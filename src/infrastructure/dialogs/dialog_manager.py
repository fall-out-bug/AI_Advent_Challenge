...
class DialogManager:
    ...
    async def add_message(self, session_id: str, role: str, content: str) -> None:
        ...
        message = DialogMessage(role=role, content=content, tokens=tokens)
    ...
    async def get_context(
        self, session_id: str, max_tokens: int = MAX_CONTEXT_TOKENS
    ) -> str:
    ...
    async def _save_to_mongo(self, session_id: str, message: DialogMessage) -> None:
    ...
    def _format_context(self, messages: List[DialogMessage], max_tokens: int) -> str:
