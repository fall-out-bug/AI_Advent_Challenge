...
{self._static_analysis_to_markdown()}
        ...
        if results:
            ...
            for component in sorted(by_component.keys()):
                ...
                for result in by_component[component]:
                    md += f"##### [{result.get('classification', 'minor').upper()}] {result.get('description', 'N/A')}\n\n"
                    md += f"**Count:** {result.get('count', 0)}  \n"
