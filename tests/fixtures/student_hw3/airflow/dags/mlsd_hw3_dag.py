...
import os, json, zipfile, pathlib, time
...
with DAG(
    ...
    split_dataset = BashOperator(
        ...
        bash_command=spark_common + "/opt/airflow/spark-jobs/split_dataset.py ",
        env={
            "MINIO_ROOT_USER": MINIO_ACCESS_KEY,
            "MINIO_ROOT_PASSWORD": MINIO_SECRET_KEY,
            "MOVIELENS_PREFIX": "latest/",
            "RAW_OUT": "s3a://raw/movielens/",
        },
    )
    ...
    features_engineering_train = BashOperator(
        ...
        env={
            ...
            "MINIO_ROOT_PASSWORD": MINIO_SECRET_KEY,
            "SPLIT": "train",
            "IN_PATH_TRAIN": "s3a://raw/movielens/train/",
            "OUT_PATH_TRAIN": "s3a://features/train/events/",
        },
    )
    ...
    features_engineering_test = BashOperator(
        ...
        env={
            ...
            "SPLIT": "test",
            "IN_PATH_TRAIN": "s3a://raw/movielens/train/",
            "IN_PATH_TEST": "s3a://raw/movielens/test/",
            "OUT_PATH_TEST": "s3a://features/test/events/",
        },
    )
    ...
    load_features = BashOperator(
        ...
        env={
            "MINIO_ROOT_USER": MINIO_ACCESS_KEY,
            "MINIO_ROOT_PASSWORD": MINIO_SECRET_KEY,
            "FEATURES_PATH": "s3a://features/test/events/",
            "REDIS_HOST": "redis",
            "REDIS_PORT": "6379",
            "REDIS_DB": "0",
            "KEY_PREFIX": "mlsd:test:user",
    ...
    train_and_save_model = BashOperator(
        ...
        bash_command="python /opt/mlflow/train_model.py",
        env={
            "MLFLOW_TRACKING_URI": MLFLOW_TRACKING_URI,
            "AWS_ACCESS_KEY_ID": MINIO_ACCESS_KEY,
            "AWS_SECRET_ACCESS_KEY": MINIO_SECRET_KEY,
            "MLFLOW_S3_ENDPOINT_URL": "http://minio:9000",
            "TRAIN_PARQUET": "s3://features/train/events/",
            "TEST_PARQUET": "s3://raw/movielens/test/",  # to read labels only
            "REDIS_HOST": "redis",
            "REDIS_PORT": "6379",
            "MODEL_NAME": "mlsd_hw3_model",
        },
    )
