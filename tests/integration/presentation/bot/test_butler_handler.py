...
from src.presentation.bot.handlers.butler_handler import setup_butler_handler, handle_any_message
...
async def mock_orchestrator():
    ...
    orchestrator.handle_user_message = AsyncMock(return_value="Integration test response")
    return orchestrator
