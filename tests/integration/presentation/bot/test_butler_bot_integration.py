...
async def test_factory_creates_orchestrator(mock_get_mcp, mock_mistral, mock_get_db):
    ...
    with patch("src.presentation.bot.factory.RobustMCPClient") as mock_robust, \
...
async def test_butler_bot_main_flow(mock_orchestrator):
    ...
    with patch("src.presentation.bot.butler_bot.create_butler_orchestrator") as mock_factory:
        ...
        with patch.dict(os.environ, {"TELEGRAM_BOT_TOKEN": "test_token"}):
            ...
            with patch("src.presentation.bot.butler_bot.Dispatcher.start_polling") as mock_poll:
