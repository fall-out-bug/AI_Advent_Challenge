...
class TestDialogManager:
    ...
    async def test_compress_history(self, mock_mongodb, mock_llm_client, sample_dialog_history):
        ...
        async def fetch_messages(*args, **kwargs):
            return [DialogMessage(**msg) for msg in sample_dialog_history * 15]  # 45 messages
