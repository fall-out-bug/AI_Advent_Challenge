...
- `docs/archive/release_notes/CHANGELOG_MCP.md` — публичный changelog обновлений MCP.
- `docs/reference/en/API_MCP.md` — англоязычная версия.
- `docs/reference/ru/API_BOT_BACKOFFICE.ru.md` — справочник по CLI (Stage 02_02).
