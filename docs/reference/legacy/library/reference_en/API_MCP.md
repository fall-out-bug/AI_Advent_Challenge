...
- `docs/archive/release_notes/CHANGELOG_MCP.md` — public changelog of MCP tooling updates.
- `docs/reference/ru/API_MCP.ru.md` — Russian localisation of this document.
- `docs/reference/en/API_BOT_BACKOFFICE.md` — CLI command reference (Stage 02_02).
