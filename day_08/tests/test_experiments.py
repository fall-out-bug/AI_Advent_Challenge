...
from models.data_models import ExperimentResult, CompressionResult, TokenInfo, ModelLimits
...
class TestTokenLimitExperiments:
    ...
    def test_count_query_tokens(self):
        ...
        assert tokens == 100
        self.mock_token_counter.count_tokens.assert_called_once_with("test query", "starcoder")
    ...
    async def test_execute_model_request_success(self):
        ...
        response_info = await self.experiments._execute_model_request("starcoder", query_info)
