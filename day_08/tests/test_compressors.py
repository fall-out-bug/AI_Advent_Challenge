...
class MockTokenCounter(TokenCounterProtocol):
    ...
    def count_tokens(self, text: str, model_name: str = "starcoder") -> TokenInfo:
        ...
        return TokenInfo(count=count, estimated_cost=0.0, model_name=model_name)
...
class TestTruncationCompressor:
    ...
    def test_no_compression_when_under_limit(self):
        ...
        result = self.compressor.compress(
            "short text", max_tokens=10, model_name="starcoder"
        )
...
class TestCompressionIntegration:
    ...
    def test_truncation_vs_keywords_compression(self):
        ...
        truncation_result = truncation_compressor.compress(
            text, max_tokens=10, model_name="starcoder"
        )
        keywords_result = keywords_compressor.compress(
            text, max_tokens=10, model_name="starcoder"
        )
