...
MEDIUM_TEXT = (
    "This is a medium length text that contains multiple sentences and should be used for performance testing of token counting and compression operations."
    * 10
)
LONG_TEXT = (
    """
...
class TestPerformanceBaseline:
    ...
    def test_memory_usage_baseline(self):
        ...
        for _ in range(100):
            ...
            # Use them
            result = counter.count_tokens(MEDIUM_TEXT, "starcoder")
            compression = compressor.compress_by_truncation(
                MEDIUM_TEXT, 1000, "starcoder"
            )
    ...
    def test_concurrent_operations_baseline(self):
        ...
        assert all(
            count == result_counts[0] for count in result_counts
        )  # All should be same
