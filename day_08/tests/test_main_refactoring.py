...
class TestApplicationBootstrapper:
    ...
    @patch('core.bootstrap.application_bootstrapper.ApplicationBootstrapper._create_reporter')
    @patch('core.bootstrap.application_bootstrapper.ApplicationBootstrapper._create_experiments')
    @patch('core.bootstrap.application_bootstrapper.ApplicationBootstrapper._create_ml_client')
    @patch('core.bootstrap.application_bootstrapper.ApplicationBootstrapper._create_text_compressor')
    @patch('core.bootstrap.application_bootstrapper.ApplicationBootstrapper._create_token_counter')
    ...
    def test_bootstrap_validation_failure(
        ...
        with pytest.raises(BootstrapError, match="Failed to validate application components"):
...
class TestRunPy:
    ...
    async def test_run_experiments_success(self):
        ...
        self.mock_context.experiments.run_limit_exceeded_experiment = AsyncMock(return_value=[Mock()])
        self.mock_context.experiments.get_experiment_summary = Mock(return_value={
            'total_experiments': 3,
        ...
        # Verify calls
        self.mock_context.ml_client.check_availability.assert_called_once_with("starcoder")
        self.mock_context.experiments.run_limit_exceeded_experiment.assert_called_once_with("starcoder")
    ...
    async def test_run_demo_success(self):
        ...
        # Setup mocks
        self.mock_context.ml_client.check_availability = AsyncMock(return_value=True)
        self.mock_context.experiments.run_short_query_experiment = AsyncMock(return_value=[Mock()])
        ...
        # Verify calls
        self.mock_context.ml_client.check_availability.assert_called_once_with("starcoder")
        self.mock_context.experiments.run_short_query_experiment.assert_called_once_with("starcoder")
    ...
    async def test_run_comparison_success(self):
        ...
        # Setup mocks
        self.mock_context.ml_client.check_availability = AsyncMock(return_value=True)
        self.mock_context.experiments.run_model_comparison_experiment = AsyncMock(return_value=[Mock()])
    ...
    async def test_run_advanced_compression_success(self):
        ...
        # Setup mocks
        self.mock_context.experiments.run_advanced_compression_experiment = AsyncMock(return_value=[Mock()])
