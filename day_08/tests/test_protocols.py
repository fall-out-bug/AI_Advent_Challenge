    ...
    def test_token_counter_protocol(self):
        ...
        class MockTokenCounter:
            ...
            def get_model_limits(self, model_name: str) -> ModelLimits:
                return ModelLimits(
                    max_input_tokens=4096, max_output_tokens=1024, max_total_tokens=6000
                )
            ...
            def estimate_compression_target(
                self, text: str, model_name: str, safety_margin: float
            ) -> int:
    ...
    def test_model_client_protocol(self):
        ...
        class MockModelClient:
            async def make_request(
                self, model_name: str, query: str, max_tokens: int = 1000
            ) -> Any:
    ...
    def test_configuration_protocol(self):
        ...
        class MockConfiguration:
            ...
            def get_model_limits(
                self, model_name: str, profile: str
