...
class AppConfig:
    ...
    def __init__(self):
        ...
        self.ml_service_retry_attempts = int(os.getenv("ML_SERVICE_RETRY_ATTEMPTS", "3"))
        ...
        self.model_client_temperature = float(os.getenv("MODEL_CLIENT_TEMPERATURE", "0.7"))
        
        # Experiment settings
        self.experiment_random_seed = int(os.getenv("EXPERIMENT_RANDOM_SEED", "42"))
        self.experiment_deterministic = os.getenv("EXPERIMENT_DETERMINISTIC", "true").lower() == "true"
        self.experiment_safety_margin = float(os.getenv("EXPERIMENT_SAFETY_MARGIN", "0.9"))
        
        # Performance settings
        self.max_concurrent_experiments = int(os.getenv("MAX_CONCURRENT_EXPERIMENTS", "5"))
