...
class TokenAnalysisRepository(ABC):
    ...
    @abstractmethod
    async def find_by_model(self, model_name: str, model_version: str) -> List[TokenAnalysisDomain]:
        """
...
class ExperimentSessionRepository(ABC):
    ...
    @abstractmethod
    async def find_by_experiment_name(self, experiment_name: str) -> List[ExperimentSession]:
        """
